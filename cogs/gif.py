...
class Gif(commands.Cog):
  ...
  async def esposo_de(self, ctx, user: commands.MemberConverter = None):
    ...
    content = self.tenor_api.esposo_de()

    gif_data = content["results"]
